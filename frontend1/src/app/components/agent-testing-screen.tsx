...
//               className="flex-1 px-4 py-2 rounded-lg bg-[#262626] border border-[#a3a3a3]/20 text-white outline-none"
//             />

//             <button
//               onClick={runTests}
//               className="px-4 py-2 rounded-lg bg-white text-black hover:bg-[#e5e5e5] transition"
//             >
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={testCaseData}>
                    ...
                    <Bar dataKey="passed" fill="#ffffff" radius={[4, 4, 0, 0]} />  
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                ...
                {logs.map((log, index) => (
                  ...
                  <div key={index}
                    className="flex items-start gap-3 p-3 rounded-lg hover:bg-[#262626]/50">
